...
populations = pd.concat([merged_data['Population_sample1'], merged_data['Population_sample2']]).unique()
...
for node in G.nodes():
    ...
    population_sample1 = merged_data.loc[merged_data['sample1'] == node, 'Population_sample1']
    population_sample2 = merged_data.loc[merged_data['sample2'] == node, 'Population_sample2']
...
plt.savefig("$result/ibd_network_population.png")
